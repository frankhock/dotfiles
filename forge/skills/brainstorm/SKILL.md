...
Those belong in `/forge:plan` after codebase research.
...
1. **Check for project folder argument**
   - If argument provided (e.g., `/forge:brainstorm 2025-01-30-ENG-123-feature`):
...
## Next Steps
- [ ] Research codebase: `/forge:research [folder-name]`
```
...
- Proceed to research: `/forge:research [folder-name]`
- Refine spec further
- Done for now

## Context Integration

**Handoff:** After spec approval, next step is `/forge:research [folder-name]` to validate assumptions and gather implementation details. The spec feeds into research, which feeds into planning.
