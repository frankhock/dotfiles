...
You are tasked with implementing an approved technical plan from the project directory. These plans contain phases with specific changes and success criteria.
...
- Iterate on plan: `/forge:iterate [folder-name]`
- Done for now
