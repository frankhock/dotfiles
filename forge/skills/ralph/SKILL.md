...
1. **Check for project folder argument**
   - If argument provided (e.g., `/forge:ralph 2025-01-27-ENG-1234-feature`):
...
3. **Present next steps using AskUserQuestion tool**:
   - Execute now: run `ralph-loop.rb` with the project folder (see Ralph execution in forge plugin README)
   - Review files first
   - Done for now
...
```
User: /forge:ralph 2025-01-27-ENG-1478-task-status
